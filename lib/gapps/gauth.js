...
exports.getCode = function (clientId, scopes) {
    ...
    var url = "https://accounts.google.com/o/oauth2/auth?" + toQS({
        response_type : 'code',
    ...
    console.log("Opening a browser at '" + url + "'  to authenticate with Google.\nIf the browser doesn't open, please visit that URL manually.");
