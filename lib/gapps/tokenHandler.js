...
exports.getTokenData = function(clientId, clientSecret, opt_dataDir, cb) {
    if (typeof opt_dataDir === 'function') {
        cb = opt_dataDir;
        opt_dataDir = undefined;
    }

    if (opt_dataDir) {
        storage.setStorageDirectory(opt_dataDir);
    }
